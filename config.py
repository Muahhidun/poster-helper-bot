...
WHATSAPP_BATCH_WINDOW_SECONDS = int(os.getenv("WHATSAPP_BATCH_WINDOW_SECONDS", "90"))
WHATSAPP_BATCH_SETTLE_SECONDS = int(os.getenv("WHATSAPP_BATCH_SETTLE_SECONDS", "15"))
...
# OCR Processor для чтения текста (гибридный подход: OCR + GPT-4)
GOOGLE_DOCAI_OCR_PROCESSOR_ID = os.getenv("GOOGLE_DOCAI_OCR_PROCESSOR_ID", "7cee4a5754267b4e")
# Invoice Parser (deprecated - плохо работает с кириллицей)
# GOOGLE_DOCAI_INVOICE_PROCESSOR_ID = os.getenv("GOOGLE_DOCAI_INVOICE_PROCESSOR_ID", "c0fd9504fc970145")
